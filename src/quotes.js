export default {
  quotes: [
    ...
    {
        id: 11,
        text: "Quality is not an act, but a habit.",
        author: "Aristotle",
    },
    {
        id: 12,
    ...
    {
        id: 21,
        text: "Never give in and never give up.",
    ...
    {
        id: 24,
        text: "You simply have to put one foot in front of the other and keep going. Put blinders on and plow right ahead.",
        author: "George Lucas",
    },
    {
        id: 25,
    ...
    {
        id: 36,
        text: "Don't give up. Don't lose hope. Don't sell out.",
    ...
    {
        id: 44,
        text: "I've viewed myself as slightly above average in talent. And where I excel is ridiculous, sickening work ethic.",
        author: "Will Smith",
    },
    {
        id: 45,
    ...
    {
        id: 50,
        text: "The No. 1 reason people fail in life is because they listen to their friends, family, and neighbors.",
        author: "Napoleon Hill",
    },
    {
        id: 51,
        text: "The greatest glory in living lies not in never failing, but in rising every time we fall.",
    ...
    {
        id: 53,
        text: "Without failure there is no achievement.",
    ...
    {
        id: 77,
        text: "Never consider the possibility of failure; as long as you persist, you will be successful.",
        author: "Brian Tracy",
    },
    {
        id: 78,
